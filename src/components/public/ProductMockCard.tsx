  ...
  return (
    <div className="relative" aria-hidden>
      <div className="pointer-events-none absolute -inset-8 -z-10">
        <div className="absolute left-1/2 top-10 h-[260px] w-[540px] -translate-x-1/2 rounded-full bg-violet-500/20 blur-[90px]" />
        <div className="absolute left-1/2 top-28 h-[220px] w-[520px] -translate-x-1/2 rounded-full bg-cyan-400/12 blur-[90px]" />
      </div>
      ...
      >
        <div className="flex items-center gap-2 border-b border-white/[0.07] bg-zinc-950/80 px-4 py-3">
            ...
            <div className="border-r border-white/[0.06] bg-zinc-950/50 p-4">
              ...
              <div className="mt-3 space-y-1">
                {[
                  ...
                  >
                    <span className={item.active ? "text-[11px] font-medium text-zinc-100" : "text-[11px] text-zinc-300"}>
                      {item.label}
                    </span>
                    {item.active ? (
